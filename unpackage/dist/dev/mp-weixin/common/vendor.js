...
var _loading = _interopRequireDefault(__webpack_require__(/*! ./loading.js */ 34));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // import Vue from 'vue'
...
var _jjToast = _interopRequireDefault(__webpack_require__(/*! ../toast/jj-toast.vue */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var showToastH5 = function showToastH5(toastData, type, duration) {
...
var showToastApp_MP = function showToastApp_MP(toastData, type, duration) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getRefList = exports.removeRefObj = exports.addRefObj = exports.getRef = exports.showMessageBox = exports.isShowAppMessageView = exports.currentPageRoute = exports.refMessageObj = void 0;
...
var getRefList = function getRefList() {
  ...
  if (currentObj !== undefined) {
    var refObj = refMessageObj()[route];
...
var _jjAlert = _interopRequireDefault(__webpack_require__(/*! ../alert/jj-alert.vue */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var showAlertApp_MP = function showAlertApp_MP(alertData, message, btnTitle) {
...
var showAlertH5 = function showAlertH5(alertData, message, btnTitle) {
  var data = getData(alertData, message, btnTitle);
  var isClose = data['isClose'] || false;
...
var showLoadingH5 = function showLoadingH5(loadingData) {
...
var showLoadingApp_MP = function showLoadingApp_MP(loadingData) {
  var data = getLoadingData(loadingData);
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _loading = _interopRequireDefault(__webpack_require__(/*! ../components/jj-messagebox/messageView/loading.js */ 34));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
