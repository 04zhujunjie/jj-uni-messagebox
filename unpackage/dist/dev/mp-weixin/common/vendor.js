...
var _loading = _interopRequireDefault(__webpack_require__(/*! ./loading.js */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(createApp) {Object.defineProperty(exports, "__esModule", { value: true });exports.removeToastH5 = exports.default = void 0;var _constant = __webpack_require__(/*! ./constant.js */ 14);
...
var _jjToast = _interopRequireDefault(__webpack_require__(/*! ../toast/jj-toast.vue */ 34));
...
};exports.removeToastH5 = removeToastH5;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getRefList = exports.removeRefObj = exports.addRefObj = exports.getRef = exports.route_uidKey = exports.showMessageBox = exports.jj_app_message_url = exports.isShowAppMessageView = exports.currentPageRoute = exports.refRouteKey = exports.refMessageObj = void 0;
...
var refRouteKey = function refRouteKey() {
  ...
  var rKey = route_uidKey(routes[routes.length - 1]);
  // console.log('--------',rKey)
  return rKey;
};exports.refRouteKey = refRouteKey;

var route_uidKey = function route_uidKey(page) {
  var uid = 0;
...
var getRefList = function getRefList(route_uid) {
  var refList = [];
  var refKey = route_uid;
  if (refKey === undefined) {
    refKey = refRouteKey();
  }
...
var _alert = __webpack_require__(/*! ./alert.js */ 17);


var _loading = __webpack_require__(/*! ./loading.js */ 26);


var _toast = __webpack_require__(/*! ./toast.js */ 13);
...
var processorObj = function processorObj(type) {
  ...
  obj.close = function () {var isAnimation = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    if (obj.isClose) {
      return;
    }
  ...
  var quickCloseVmFun = function quickCloseVmFun() {
    var refList = (0, _ref.getRefList)(obj.messageObj.route_uid);
    for (var i = 0; i < refList.length; i++) {
      var ref = refList[i];
      ref.quickClose();
    }
  };
  var setupAppCloseFun = function setupAppCloseFun(uid, fun) {
    var routes = getCurrentPages() || []; // 获取当前打开过的页面路由数组
    var length = routes.length;
    var index = 0; //遮罩层路由的索引
    for (var i = length - 1; i >= 0; i--) {
      var page = routes[i];
      var route_uid = (0, _ref.route_uidKey)(page);
      if (uid === route_uid) {
        index = i;
        break;
      }
    }
    var curprocessorVM = routes[index].$vm; //遮罩层组件对象
    //调用返回上一页面方法
    curprocessorVM.backPage(function () {
      if (typeof fun === 'function') {
        obj.messageObj = null;
        fun();
      }
  ...
  var removeData = function removeData(isAnimation) {
    obj.isClose = true;
    if (isAnimation) {
  ...
  obj.update = function (param1, param2, param3) {
    ...
    if (obj.processDataFun !== null) {
      var updateData = updateDataFun(param1, param2, param3);
      if (obj.messageObj !== null) {
  ...
  var updateDataFun = function updateDataFun(param1, param2, param3) {
    var data = {};
...
"use strict";
/* WEBPACK VAR INJECTION */(function(createApp) {Object.defineProperty(exports, "__esModule", { value: true });exports.removeAlertH5 = exports.default = void 0;var _constant = __webpack_require__(/*! ./constant.js */ 14);
...
var _processor = _interopRequireDefault(__webpack_require__(/*! ./processor.js */ 16));
var _jjAlert = _interopRequireDefault(__webpack_require__(/*! ../alert/jj-alert.vue */ 18));
...
var removeAlertH5 = function removeAlertH5() {var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { priority: 0 };
  ...
  return false;
};exports.removeAlertH5 = removeAlertH5;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(createApp) {Object.defineProperty(exports, "__esModule", { value: true });exports.removeLoadingH5 = exports.default = void 0;var _constant = __webpack_require__(/*! ./constant.js */ 14);
...
var _processor = _interopRequireDefault(__webpack_require__(/*! ./processor.js */ 16));
var _jjLoading = _interopRequireDefault(__webpack_require__(/*! ../loading/jj-loading.vue */ 27));
...
};exports.removeLoadingH5 = removeLoadingH5;
