...
(function(shared, vue) {
  ...
  const background_image = function() {
  ...
  const bg_custom_update = function() {
          ...
          btns: [
            {
              ...
              click: () => {
                formatAppLog("log", "at pages/index/header.vue:54", "\u4EE5\u540E\u518D\u8BF4");
              }
            },
            {
              title: "\u7ACB\u5373\u66F4\u65B0",
              ...
              click: () => {
                formatAppLog("log", "at pages/index/header.vue:67", "\u7ACB\u5373\u66F4\u65B0");
  ...
  function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", { class: "header-box" }, [
      vue.createElementVNode("button", {
        class: "btn",
        onClick: _cache[0] || (_cache[0] = ($event) => $options.showToast(""))
      }, "toast"),
      vue.createElementVNode("button", {
        class: "btn",
        onClick: _cache[1] || (_cache[1] = ($event) => $options.showToast("success"))
      }, "toast-success"),
      vue.createElementVNode("button", {
        class: "btn",
        onClick: _cache[2] || (_cache[2] = (...args) => $options.updateVersion && $options.updateVersion(...args))
      }, "\u66F4\u65B0\u7248\u672C")
    ]);
  }
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("view", { class: "content" }, [
          vue.createElementVNode("view", null, [
            vue.createVNode(_component_header_view),
            vue.createElementVNode("button", {
              style: { "margin-top": "20px" },
              onClick: _cache[0] || (_cache[0] = ($event) => $options.goDemo())
            }, "Demo")
          ])
        ])
      ]),
  ...
  const loading_round_icon = function() {
  ...
  const loading_taichi_icon = function() {
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    return $data.jj_visible ? (vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("div", {
        class: "messagebox-shade",
        style: vue.normalizeStyle([{ "background-color": $props.maskColor }]),
        onTouchmove: _cache[2] || (_cache[2] = vue.withModifiers(() => {
        }, ["stop"])),
        onClick: _cache[3] || (_cache[3] = ($event) => $props.touchClose ? $options.close() : "")
      }, [
        vue.createElementVNode("div", {
          class: "messagebox-main popIn",
          onClick: _cache[1] || (_cache[1] = (...args) => $options.mainClick && $options.mainClick(...args)),
          style: vue.normalizeStyle([{ "animation-duration": $props.duration + "s", "width": $props.width, "background": $props.background, "border-radius": $props.radius + "px" }])
        }, [
          vue.createElementVNode("div", { class: "background-content" }, [
            vue.renderSlot(_ctx.$slots, "backgroundContent", {}, void 0, true)
          ]),
          vue.createElementVNode("div", {
            ...
            $props.showClose ? (vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.createElementVNode("image", {
                class: "closeImage",
                style: vue.normalizeStyle([$props.closeStyle]),
                src: $options.closeImgUrl
              }, null, 12, ["src"])
            ])) : vue.createCommentVNode("v-if", true),
            $props.title.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 1,
              class: "flexCenter",
            ...
            $props.message.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 2,
              class: "flexCenter",
              style: vue.normalizeStyle([{ "margin-top": "10px" }, [$props.messageStyle]])
            }, [
  ...
  function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
    return $data.jj_visible ? (vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("div", {
        class: vue.normalizeClass(["messagebox-shade", [!$data.isPopup ? "fadelogOutOpcity" : ""]]),
        style: vue.normalizeStyle([{ "justify-content": "flex-end", "align-items": "flex-end" }, [{ "background-color": $props.maskColor }]]),
        onTouchmove: _cache[3] || (_cache[3] = vue.withModifiers(() => {
        }, ["stop"])),
        onClick: _cache[4] || (_cache[4] = ($event) => $props.touchClose ? $options.close() : "")
      }, [
        vue.createElementVNode("div", {
          class: vue.normalizeClass(["messagebox-main fadelogIn", [$data.isPopup ? "" : "fadelogOut"]]),
          onAnimationend: _cache[1] || (_cache[1] = (...args) => $options.animationend && $options.animationend(...args)),
          onClick: _cache[2] || (_cache[2] = vue.withModifiers((...args) => $options.mainClick && $options.mainClick(...args), ["stop"])),
          style: vue.normalizeStyle([{ "margin": "0px", "width": "100%", "border-bottom-left-radius": "0px", "border-bottom-right-radius": "0px" }, [{ "animation-duration": $props.duration + "s", "height": $props.height, "background": $props.background, "border-top-left-radius": $props.radius + "px", "border-top-right-radius": $props.radius + "px" }]])
        }, [
          vue.createElementVNode("div", { class: "background-content" }, [
            vue.renderSlot(_ctx.$slots, "backgroundContent", {}, void 0, true)
          ]),
  ...
  function _sfc_render$f(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(_component_base_view, null, {
      default: vue.withCtx(() => [
        vue.createElementVNode("map", { style: { "width": "100%", "height": "150px" } }),
        vue.createElementVNode("div", { class: "flexColumnCenter" }, [
          vue.createElementVNode("div", { class: "flexRow marginTopBottom" }, [
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[0] || (_cache[0] = (...args) => $options.showNormalAlert && $options.showNormalAlert(...args))
            }, " \u9ED8\u8BA4Alert "),
            vue.createElementVNode("button", {
              class: "btn",
              style: { "margin-left": "10px" },
              onClick: _cache[1] || (_cache[1] = ($event) => $options.showCustomAlert("alert", false))
            }, " \u6CA1\u6709\u6309\u94AE\u7684Alert "),
            vue.createElementVNode("button", {
              class: "btn marginLeftRight",
              onClick: _cache[2] || (_cache[2] = ($event) => $options.showCustomAlert("alert"))
            }, " \u81EA\u5B9A\u4E49Alert "),
            vue.createElementVNode("button", {
              class: "btn marginLeftRight",
              onClick: _cache[3] || (_cache[3] = ($event) => $options.showCustomAlert("alert", true, "column"))
            }, " \u6309\u94AE\u7AD6\u6392Alert "),
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[4] || (_cache[4] = ($event) => $options.showCustomAlert("alert", true, "column", "bottom"))
            }, " \u5E95\u90E8\u5F39\u51FAAlert "),
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[5] || (_cache[5] = ($event) => $options.showCustomAlert("sheet"))
            }, " \u81EA\u5B9A\u4E49Sheet ")
          ]),
          vue.createElementVNode("div", { class: "flexRow marginTopBottom" }, [
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[6] || (_cache[6] = (...args) => $options.showDialog && $options.showDialog(...args))
            }, "Dialog")
          ]),
          vue.createElementVNode("div", { class: "flexRow marginTopBottom" }, [
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[7] || (_cache[7] = (...args) => $options.showPopup && $options.showPopup(...args))
            }, "Popup")
          ]),
          vue.createElementVNode("div", { class: "flexRow marginTopBottom" }, [
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[8] || (_cache[8] = ($event) => $options.showLoading("default"))
            }, "Loading"),
            vue.createElementVNode("button", {
              class: "btn",
              style: { "margin-left": "10px" },
              onClick: _cache[9] || (_cache[9] = ($event) => $options.showLoading("round"))
            }, "Loading-round"),
            vue.createElementVNode("button", {
              class: "btn marginLeftRight",
              onClick: _cache[10] || (_cache[10] = ($event) => $options.showLoading("taichi"))
            }, "Loading-taichi"),
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[11] || (_cache[11] = ($event) => $options.showLoading("custom"))
            }, "Loading-\u81EA\u5B9A\u4E49")
          ]),
          vue.createElementVNode("div", { class: "flexRow marginTopBottom" }, [
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[12] || (_cache[12] = ($event) => $options.showToast(""))
            }, "toast"),
            vue.createElementVNode("button", {
              class: "btn marginLeftRight",
              onClick: _cache[13] || (_cache[13] = ($event) => $options.showToast("success"))
            }, "toast-success"),
            vue.createElementVNode("button", {
              class: "btn",
              onClick: _cache[14] || (_cache[14] = ($event) => $options.showToast("fail"))
            }, "toast-fail"),
            vue.createElementVNode("button", {
              class: "btn marginLeftRight",
              onClick: _cache[15] || (_cache[15] = ($event) => $options.showToast("warn"))
            }, "toast-warn"),
            vue.createElementVNode("button", {
              class: "btn",
              style: { "margin-left": "10px" },
              onClick: _cache[16] || (_cache[16] = ($event) => $options.showToast("custom"))
            }, "toast-\u81EA\u5B9A\u4E49")
          ]),
          vue.createVNode(_component_jj_dialog, {
            visible: $data.isShowDialog,
            titleStyle: { "color": "red" },
            title: "\u63D0\u793A",
            message: "\u5916\u5C42Dialog",
            onClose: _cache[19] || (_cache[19] = ($event) => $data.isShowDialog = false)
          }, {
            default: vue.withCtx(() => [
              vue.createElementVNode("image", {
                slot: "backgroundContent",
                class: "image",
                src: $options.backgroundImg
              }, null, 8, ["src"]),
              vue.createElementVNode("div", null, " \u81EA\u5B9ADialog\u5185\u5BB9"),
              vue.createVNode(_component_jj_dialog, {
                width: "60%",
                title: "\u5185\u5C42Dialog",
                visible: $data.innerVisible,
                onClose: _cache[17] || (_cache[17] = ($event) => $data.innerVisible = false)
              }, null, 8, ["visible"]),
              vue.createElementVNode("div", { slot: "footer" }, [
                vue.createElementVNode("button", {
                  class: "btn",
                  style: { "margin-bottom": "10px" },
                  onClick: _cache[18] || (_cache[18] = ($event) => $data.innerVisible = true)
                }, "\u6253\u5F00\u5185\u5C42Dialog")
              ])
            ]),
            _: 1
          }, 8, ["visible"]),
          vue.createVNode(_component_jj_popup, {
            ...
            default: vue.withCtx(() => [
              ...
              vue.createElementVNode("div", null, " \u4ECA\u5929\u5929\u6C14\u4E0D\u9519")
            ]),
            _: 1
          }, 8, ["visible", "onClose"])
        ])
    ...
    methods: {
      showAlert() {
        let alert = this.$jj_alert({
          ...
          isUseHTMLString: true,
          message: "<strong>\u8FD9\u662F <i>HTML</i> \u7247\u6BB5,<span style='color:orange;margin:0px 8px'>\u9875\u9762\u8DF3\u8F6C\u6F14\u793A</span></strong>",
          messageStyle: {
          ...
          btns: [{
            ...
            activeColor: "#fff",
            click: () => {
              formatAppLog("log", "at pages/app/index.vue:66", "\u70B9\u51FBCancel");
            }
          }, {
            title: "\u5173\u95ED\u5F39\u7A97\u8DF3\u8F6C",
            style: {
            ...
            touchClose: false,
            click: () => {
              formatAppLog("log", "at pages/app/index.vue:76", "\u70B9\u51FB\u5173\u95ED\u5F39\u7A97\u8DF3\u8F6C");
              alert.closeAll(function() {
                uni.navigateTo({
                  url: "/pages/demo/index",
                  animationDuration: 0
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createBlock(_component_base_view, { class: "flexColumnCenter" }, {
      default: vue.withCtx(() => [
        vue.createElementVNode("button", {
          class: "btn marginTopBottom",
          onClick: _cache[0] || (_cache[0] = (...args) => $options.showAlert && $options.showAlert(...args))
        }, " \u9875\u9762\u8DF3\u8F6C "),
        vue.createElementVNode("button", {
          class: "btn marginTopBottom",
          onClick: _cache[1] || (_cache[1] = (...args) => $options.showPopup && $options.showPopup(...args))
        }, " showPopup "),
        $options.isShowMap ? (vue.openBlock(), vue.createElementBlock("map", {
          key: 0,
          class: "marginTopBottom",
          style: { "width": "100%", "height": "150px", "margin-top": "250px" }
        })) : vue.createCommentVNode("v-if", true)
      ]),
      _: 1
    });
  ...
  var PagesMpTest1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/mp/test1.vue"]]);
  const _sfc_main$b = {
    mounted() {
      this.$jj_alert({
        title: "\u63D0\u793A",
  ...
  var PagesMpTest2 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/mp/test2.vue"]]);
  let kToast = "jj_toast";
  let kAlert = "jj_alert";
  ...
  function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
    return $data.isShow ? (vue.openBlock(), vue.createElementBlock("div", {
      key: 0,
      class: "messagebox-shade",
      style: vue.normalizeStyle([{ "background-color": $data.maskColor, "pointer-events": "none" }]),
      onTouchmove: _cache[0] || (_cache[0] = vue.withModifiers(() => {
      }, ["stop"]))
    }, [
      vue.createElementVNode("div", {
        class: "messagebox-main",
        style: vue.normalizeStyle([{ "width": "auto", "minWidth": $data.minWidth, "maxWidth": $data.maxWidth, "background": $data.background, "border-radius": $data.radius + "px" }])
      }, [
        vue.createElementVNode("div", {
          class: "messagebox-content",
          style: vue.normalizeStyle([{ "padding": $data.padding }])
        }, [
          $options.imgUrl.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: "flexContentCenter"
          }, [
            vue.createElementVNode("div", {
              style: vue.normalizeStyle([{ "margin-bottom": "6px" }, [$options.setImageSize]])
            }, [
              vue.createElementVNode("image", {
                class: "image",
                src: $options.imgUrl
          ...
          vue.createElementVNode("div", { class: "flexContentCenter" }, [
            vue.createElementVNode("span", {
              class: "message",
              style: vue.normalizeStyle([$data.messageStyle])
            }, vue.toDisplayString($data.message), 5)
          ])
        ], 4)
      ], 4)
    ], 36)) : vue.createCommentVNode("v-if", true);
  }
  var toastH5 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__scopeId", "data-v-0666c070"], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/toast/jj-toast.vue"]]);
  const _sfc_main$9 = {
    props: {
      btnObj: {
        type: Object,
  ...
  function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      ...
      onClick: _cache[0] || (_cache[0] = vue.withModifiers(($event) => $options.click(), ["stop"])),
      onTouchstart: _cache[1] || (_cache[1] = ($event) => $options.touchstart()),
      onTouchend: _cache[2] || (_cache[2] = ($event) => $options.touchend())
    }, vue.toDisplayString($props.btnObj.title), 37);
  }
  var jjButton = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-6fd3b3a4"], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/alert/jj-button.vue"]]);
  const _sfc_main$8 = {
    props: {
      customData: {
        type: Object,
  ...
  function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_jj_button = vue.resolveComponent("jj-button");
    return vue.openBlock(), vue.createElementBlock("div", { class: "flex-column update-box" }, [
      $options.backgroundImgUrl.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", { key: 0 }, [
        vue.createElementVNode("div", { class: "background-image" }, [
          vue.createElementVNode("image", {
            class: "image",
            src: $options.backgroundImgUrl
          }, null, 8, ["src"])
        ])
      ])) : vue.createCommentVNode("v-if", true),
      vue.createElementVNode("div", {
        class: "flex-column flexContentCenter title",
        style: vue.normalizeStyle([{ "margin-top": $options.backgroundImgUrl.length > 0 ? "100px" : "0" }])
      }, vue.toDisplayString($options.customDataObj.title), 5),
      vue.createElementVNode("div", {
        class: "flex-column flex-left marginTop content",
        style: { "font-weight": "bold" }
      }, vue.toDisplayString($options.customDataObj.contentTitle), 1),
      vue.createElementVNode("div", { class: "flex-column flex-left" }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.contentList, (content, index) => {
          return vue.openBlock(), vue.createElementBlock("div", {
            class: "content marginTop",
            key: content
          }, vue.toDisplayString(content), 1);
        }), 128))
      ]),
      vue.createElementVNode("div", {
        class: "flexContentSpaceAround marginTop",
        style: { "margin-top": "20px" }
      }, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.btnsList, (btn, index) => {
          return vue.openBlock(), vue.createElementBlock("div", {
            class: "btn-box",
            key: index
          }, [
            vue.createVNode(_component_jj_button, {
              class: "btn",
              btnObj: btn,
              onBtnClick: ($event) => $options.clickFn(index)
            }, null, 8, ["btnObj", "onBtnClick"])
          ]);
        }), 128))
      ])
    ]);
  }
  var updateVersion = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-52dc9024"], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/alert/update-version-alert.vue"]]);
  const _sfc_main$7 = {
    components: {
      updateVersion
    },
  ...
  function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_update_version = vue.resolveComponent("update-version");
    return vue.openBlock(), vue.createElementBlock("div", null, [
      $props.customData.type === "updateVersion" ? (vue.openBlock(), vue.createBlock(_component_update_version, {
        key: 0,
        onClickBtn: $options.clickBtn,
        customData: $props.customData
      }, null, 8, ["onClickBtn", "customData"])) : vue.createCommentVNode("v-if", true)
    ]);
  }
  var customAlert = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/alert/custom-alert.vue"]]);
  const _sfc_main$6 = {
    name: "jj-alert",
    components: {
      jjButton,
      ...
      clickFn(btn) {
        ...
        if (btn.click !== void 0) {
          if (typeof btn.click === "function") {
            ...
            formatAppLog("warn", "at pages/components/jj-messagebox/alert/jj-alert.vue:282", "\u8BF7\u4F20\u5165\u56DE\u8C03\u51FD\u6570");
          }
        }
      }
    }
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_jj_button = vue.resolveComponent("jj-button");
    const _component_custom_alert = vue.resolveComponent("custom-alert");
    return $data.isShow ? (vue.openBlock(), vue.createElementBlock("div", { key: 0 }, [
      $data.position === "bottom" || $data.type === "sheet" ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        class: vue.normalizeClass(["messagebox-shade fadeInOpcity", [$data.isCloseAlert ? "fadelogOutOpcity" : ""]]),
        style: vue.normalizeStyle([{ "justify-content": "flex-end", "align-items": "flex-end" }, [{ "background-color": $data.maskColor }]]),
        onTouchmove: _cache[3] || (_cache[3] = vue.withModifiers(() => {
        }, ["stop"])),
        onClick: _cache[4] || (_cache[4] = ($event) => $data.touchClose ? $options.close() : "")
      }, [
        vue.createElementVNode("div", {
          class: vue.normalizeClass(["fadelogIn", [$data.isCloseAlert ? "fadelogOut" : ""]]),
          style: vue.normalizeStyle([[{ "animation-duration": $data.duration + "s", "width": "100%", "max-height": $data.maxHeight }], { "display": "flex", "flex-direction": "column", "justify-content": "center", "align-items": "center" }]),
          onAnimationend: _cache[2] || (_cache[2] = (...args) => $options.animationend && $options.animationend(...args))
        }, [
          vue.createElementVNode("div", {
            class: "messagebox-main",
            onClick: _cache[1] || (_cache[1] = vue.withModifiers((...args) => $options.mainClick && $options.mainClick(...args), ["stop"])),
            style: vue.normalizeStyle([{ "margin": "0px", "border-bottom-left-radius": "0px", "border-bottom-right-radius": "0px" }, [{ "width": $options.alertWidth, "background": $data.background, "border-top-left-radius": $data.radius + "px", "border-top-right-radius": $data.radius + "px" }]])
          }, [
            vue.createElementVNode("div", {
              class: "messagebox-content",
              style: vue.normalizeStyle([{ "padding": $data.padding }])
            }, [
              !$options.isCustomType ? (vue.openBlock(), vue.createElementBlock("div", { key: 0 }, [
                $data.title.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
                  key: 0,
                  class: "flexCenter",
                  style: vue.normalizeStyle([{ "font-size": "1.125rem" }, [$data.titleStyle]])
                }, [
                  vue.createElementVNode("span", null, vue.toDisplayString($data.title), 1)
                ], 4)) : vue.createCommentVNode("v-if", true),
                $data.message.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
                  key: 1,
                  class: "flexCenter",
                  style: vue.normalizeStyle([{ "margin-top": "10px" }, [$data.messageStyle]])
                }, [
                  !$data.isUseHTMLString ? (vue.openBlock(), vue.createElementBlock("span", { key: 0 }, vue.toDisplayString($data.message), 1)) : (vue.openBlock(), vue.createElementBlock("div", {
                    key: 1,
                    innerHTML: $data.message
                  }, null, 8, ["innerHTML"]))
                ], 4)) : vue.createCommentVNode("v-if", true)
              ])) : vue.createCommentVNode("v-if", true),
              $data.showClose ? (vue.openBlock(), vue.createElementBlock("div", {
                key: 1,
                class: "rightTopClose",
                onClick: _cache[0] || (_cache[0] = (...args) => $options.close && $options.close(...args))
              }, [
                vue.createElementVNode("image", {
                  class: "closeImage",
                  style: vue.normalizeStyle([$data.closeStyle]),
                  src: $options.closeImgUrl
                }, null, 12, ["src"])
              ])) : vue.createCommentVNode("v-if", true)
            ], 4),
            !$options.isCustomType ? (vue.openBlock(), vue.createElementBlock("div", { key: 0 }, [
              $options.buttonDirection === "row" ? (vue.openBlock(), vue.createElementBlock("div", {
                key: 0,
                class: "jj-alert-btns flexContentSpaceAround"
              }, [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.btns, (btn, index) => {
                  return vue.openBlock(), vue.createBlock(_component_jj_button, {
                    class: "jj-alert-btn",
                    key: index,
                    style: vue.normalizeStyle([$options.btnStyle(btn)]),
                    btnObj: btn,
                    onBtnClick: ($event) => $options.clickFn(btn)
                  }, null, 8, ["style", "btnObj", "onBtnClick"]);
                }), 128))
              ])) : (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 1 }, vue.renderList($data.btns, (btn, index) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                  class: "jj-alert-btns flexContentCenter",
                  key: index
                }, [
                  vue.createVNode(_component_jj_button, {
                    class: "jj-sheet-btn",
                    ...
                    style: vue.normalizeStyle([$options.btnStyle(btn)]),
                    onBtnClick: ($event) => $options.clickFn(btn)
                  }, null, 8, ["btnObj", "style", "onBtnClick"])
                ]);
              }), 128))
            ])) : (vue.openBlock(), vue.createElementBlock("div", { key: 1 }, [
              vue.createVNode(_component_custom_alert, {
                onClickBtn: $options.clickCustomAlertBtn,
                customData: $data.customAlertData
              }, null, 8, ["onClickBtn", "customData"])
            ]))
          ], 4)
        ], 38)
        ...
        key: 1,
        class: vue.normalizeClass(["messagebox-shade fadeInOpcity", [$data.isCloseAlert ? "fadelogOutOpcity" : ""]]),
        style: vue.normalizeStyle({ "background-color": $data.maskColor }),
        onTouchmove: _cache[8] || (_cache[8] = vue.withModifiers(() => {
        }, ["stop"])),
        onClick: _cache[9] || (_cache[9] = ($event) => $data.touchClose ? $options.close() : "")
      }, [
        vue.createElementVNode("div", {
          class: vue.normalizeClass(["messagebox-main popIn", [$data.isCloseAlert ? "popOut" : ""]]),
          onAnimationend: _cache[6] || (_cache[6] = (...args) => $options.animationend && $options.animationend(...args)),
          onClick: _cache[7] || (_cache[7] = vue.withModifiers((...args) => $options.mainClick && $options.mainClick(...args), ["stop"])),
          style: vue.normalizeStyle([{ "animation-duration": $data.duration + "s", "width": $options.alertWidth, "border-radius": $data.radius + "px", "background": $data.background }])
        }, [
          vue.createElementVNode("div", {
            class: "messagebox-content",
            style: vue.normalizeStyle([{ "padding": !$options.isCustomType ? $data.padding : "0" }])
          }, [
            !$options.isCustomType ? (vue.openBlock(), vue.createElementBlock("div", { key: 0 }, [
              $data.title.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
                key: 0,
  ...
  var alertH5 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-432dbc10"], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/alert/jj-alert.vue"]]);
  const _sfc_main$5 = {
    name: "jj-loading",
    data() {
      return {
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return $data.isShow ? (vue.openBlock(), vue.createElementBlock("div", {
      ...
      style: vue.normalizeStyle([{ "background-color": $data.maskColor, "pointer-events": $data.userInteractionEnabled ? "none" : "auto" }])
    }, [
      vue.createElementVNode("div", {
        class: "messagebox-main",
        style: vue.normalizeStyle([{ "width": $data.width, "minHeight": "85px", "background": $data.background, "border-radius": $data.radius + "px" }])
      }, [
        $data.message.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: "messagebox-content",
          ...
          vue.createElementVNode("div", { class: "flexContentCenter" }, [
            vue.createElementVNode("image", {
              class: "loading-image",
              style: vue.normalizeStyle([$options.setImageSize, { "animation-duration": $data.duration + "s" }]),
              src: $options.imgUrl
            }, null, 12, ["src"]),
            vue.createElementVNode("span", {
              class: "message",
              style: vue.normalizeStyle([{ "margin-top": "6px" }, [$data.messageStyle]])
            }, vue.toDisplayString($data.message), 5)
          ])
  ...
  var loadingH5 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-0de08b90"], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/loading/jj-loading.vue"]]);
  const _sfc_main$4 = {
    name: "message-view",
    components: {
      toast: toastH5,
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createVNode(_component_alert, {
        ref: $data.ref.kAlert,
        onShow: _cache[0] || (_cache[0] = ($event) => $options.show($data.ref.kAlert)),
        onClose: _cache[1] || (_cache[1] = ($event) => $options.close($data.ref.kAlert))
      }, null, 512),
      vue.createVNode(_component_toast, {
        ref: $data.ref.kToast,
        onShow: _cache[2] || (_cache[2] = ($event) => $options.show($data.ref.kToast)),
        onClose: _cache[3] || (_cache[3] = ($event) => $options.close($data.ref.kToast))
      }, null, 512),
      vue.createVNode(_component_loading, {
        ref: $data.ref.kLoading,
        onShow: _cache[4] || (_cache[4] = ($event) => $options.show($data.ref.kLoading)),
        onClose: _cache[5] || (_cache[5] = ($event) => $options.close($data.ref.kLoading))
      }, null, 512),
      vue.renderSlot(_ctx.$slots, "default")
    ]);
  }
  var messageView = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/messageView/index.vue"]]);
  const _sfc_main$3 = {
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_message_view = vue.resolveComponent("message-view");
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createVNode(_component_message_view, { onClose: $options.close }, null, 8, ["onClose"])
    ]);
  }
  var PagesComponentsJjMessageboxMessageViewAppMessageView = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/components/jj-messagebox/messageView/app-message-view.vue"]]);
  const _sfc_main$2 = {
    components: {
      jjPopup
    },
    ...
    onLoad(options) {
      formatAppLog("log", "at pages/app/popup-view.vue:32", "------\u4E0A\u4E00\u4E2A\u9875\u9762\u4F20\u8FC7\u6765\u7684\u53C2\u6570-----", options);
    },
    methods: {
      closePopup() {
        uni.navigateBack({});
    ...
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createVNode(_component_jj_popup, {
        ...
        default: vue.withCtx(() => [
          ...
          vue.createElementVNode("div", { style: { "color": "#007AFF", "margin-top": "10px" } }, " \u4ECA\u5929\u5929\u6C14\u4E0D\u9519")
        ]),
        _: 1
      }, 8, ["visible", "onClose"])
    ]);
  }
  var PagesAppPopupView = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-01a1d68d"], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/app/popup-view.vue"]]);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/mine/index", PagesMineIndex);
  __definePage("pages/app/index", PagesAppIndex);
  __definePage("pages/demo/index", PagesDemoIndex);
  __definePage("pages/mp/test1", PagesMpTest1);
  __definePage("pages/mp/test2", PagesMpTest2);
  __definePage("pages/components/jj-messagebox/messageView/app-message-view", PagesComponentsJjMessageboxMessageViewAppMessageView);
  __definePage("pages/app/popup-view", PagesAppPopupView);
  const _sfc_main$1 = {
    onLaunch: function() {
  ...
  var App = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/App.vue"]]);
  const _sfc_main = {
    name: "base-view",
    components: {
      messageView
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_message_view = vue.resolveComponent("message-view");
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.createVNode(_component_message_view),
      vue.renderSlot(_ctx.$slots, "default")
    ]);
  }
  var baseView = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/weiqu/Documents/GitApp/jj-uni-messagebox/pages/baseView/index.vue"]]);
  let jj_alert = function(alertData, message, btnTitle) {
    const data = getData$1(alertData, message, btnTitle);
    let obj = processorObj(kAlert);
    obj.processDataFun = getData$1;
  ...
  let getData$1 = function(alertData, message, btnTitle) {
    let data = {};
  ...
  let processorObj = function(type) {
    ...
    let setupAppCloseFun = function(uid, fun) {
      ...
      let curprocessorVM = routes[index].$vm;
