...
const _sfc_main = {
  ...
  methods: {
      ...
      setTimeout(function() {
        ...
        alert.update({
          ...
          btns: [{
            ...
            click: () => {
              formatAppLog("log", "at pages/demo/nvue.nvue:66", "\u70B9\u51FB-----\u786E\u5B9A");
            }
          }]
        });
      }, 2e3);
    ...
    showCustomAlert(type, isShowBtn = true) {
      ...
      let alert = getApp().globalData.$jj_alert({
        ...
        btns: isShowBtn === false ? [] : [{
          ...
          activeColor: "#fff",
          click: () => {
            formatAppLog("log", "at pages/demo/nvue.nvue:120", "\u70B9\u51FBCancel");
          }
        }, {
          title: "Destructive",
          style: {
          ...
          click: () => {
            formatAppLog("log", "at pages/demo/nvue.nvue:129", "\u70B9\u51FBDestructive");
          }
        }, {
          title: "Confirm",
    ...
    simulateNetworkRequest(btn, alert) {
      ...
      btn.isDisable = true;
      formatAppLog("log", "at pages/demo/nvue.nvue:156", btn);
      if (this.count % 2 === 0) {
        setTimeout(function() {
          btn.isDisable = false;
